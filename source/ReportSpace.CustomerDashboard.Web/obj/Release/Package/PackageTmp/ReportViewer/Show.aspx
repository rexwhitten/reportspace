...
<body>
    <form id="reportForm" runat="server" style="width:100%">
        ...
        <div class="container-fluid">
            <a:ReportViewer ID="mainReportViewer" runat="server" Width="100%" Height="100%" 
                ...
                ShowCredentialPrompts="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="container navbar navbar-inverse" DocumentMapWidth="100%" InternalBorderStyle="None" ShowDocumentMapButton="False" ShowPageNavigationControls="True" ToolBarItemBorderStyle="None" WaitControlDisplayAfter="100"/>
        </div>
    </form>
    ...
    <script type="text/javascript">
        ...
        $('#mainReportViewer_fixedTable').width("1200px");
    </script>
</body>
</html>